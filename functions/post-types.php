...
function theme_post_types() {
	...
	register_post_type('event', [
		...
		'labels' => [
			...
			'add_new_item'       => 'Добавить новое событие', // заголовка у вновь создаваемой записи в админ-панели.
			'edit_item'          => 'Редактировать событие', // для редактирования типа записи
			'new_item'           => 'Новое событие', // текст новой записи
			'view_item'          => 'Просмотреть событие', // для просмотра записи этого типа.
			'search_items'       => 'Найти событие', // для поиска по этим типам записи
			'not_found'          => 'События не найдены', // если в результате поиска ничего не было найдено
			'not_found_in_trash' => 'Нет подходящих событий в корзине', // если не было найдено в корзине
			'parent_item_colon'  => '', // для родителей (у древовидных типов)
			'menu_name'          => 'События', // название меню
		],
		'description'         => 'Определяют события, представленные на странице "Ближайшие мероприятия"',
		'public'              => true,
		'publicly_queryable'  => null, // зависит от public
		'exclude_from_search' => null, // зависит от public
		'show_ui'             => null, // зависит от public
	...
	register_post_type('numerology-section', [
		'label'  => null,
		'labels' => [
			'name'               => 'Секции нумерологии', // основное название для типа записи
			'singular_name'      => 'Секция нумерологии', // название для одной записи этого типа
			'add_new'            => 'Добавить секцию', // для добавления новой записи
			'add_new_item'       => 'Добавить новую секцию', // заголовка у вновь создаваемой записи в админ-панели.
			'edit_item'          => 'Редактировать секцию', // для редактирования типа записи
			'new_item'           => 'Новая секция', // текст новой записи
			...
			'not_found_in_trash' => 'Нет подходящих секций в корзине', // если не было найдено в корзине
			'parent_item_colon'  => '', // для родителей (у древовидных типов)
			'menu_name'          => 'Секции нумерологии', // название меню
		],
		'description'         => 'Определяют секции, представленные на странице "Нумерология"',
		'public'              => true,
		'publicly_queryable'  => null, // зависит от public
		'exclude_from_search' => null, // зависит от public
		'show_ui'             => null, // зависит от public
